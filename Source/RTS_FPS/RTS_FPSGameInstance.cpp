	...
	: Super(ObjectInitializer)
{
	...
	OnCreateSessionCompleteDelegate = FOnCreateSessionCompleteDelegate::CreateUObject(this, &URTS_FPSGameInstance::OnCreateSessionComplete);
	OnStartSessionCompleteDelegate = FOnStartSessionCompleteDelegate::CreateUObject(this, &URTS_FPSGameInstance::OnStartOnlineGameComplete);
	/** Bind function for FINDING a Session */
	OnFindSessionsCompleteDelegate = FOnFindSessionsCompleteDelegate::CreateUObject(this, &URTS_FPSGameInstance::OnFindSessionsComplete);
...
void URTS_FPSGameInstance::OnCreateSessionComplete(FName SessionName, bool bWasSuccessful)
{
...
void URTS_FPSGameInstance::OnStartOnlineGameComplete(FName SessionName, bool bWasSuccessful)
{
...
void URTS_FPSGameInstance::FindSessions(TSharedPtr<const FUniqueNetId> UserId, bool bIsLAN, bool bIsPresence)
{
...
void URTS_FPSGameInstance::OnFindSessionsComplete(bool bWasSuccessful)
{
...
bool URTS_FPSGameInstance::RTS_FPSJoinSession(TSharedPtr<const FUniqueNetId> UserId, FName SessionName, const FOnlineSessionSearchResult& SearchResult)
{
	// Return bool
...
void URTS_FPSGameInstance::OnJoinSessionComplete(FName SessionName, EOnJoinSessionCompleteResult::Type Result)
{
	...
	if (OnlineSub)
	{
		// Get SessionInterface from the OnlineSubsystem
		IOnlineSessionPtr Sessions = OnlineSub->GetSessionInterface();
		GEngine->AddOnScreenDebugMessage(-1, 10.f, FColor::Red, "Pre Session Validity Check");
		if (Sessions.IsValid())
		{
			GEngine->AddOnScreenDebugMessage(-1, 10.f, FColor::Red, "Session is valid");
...
void URTS_FPSGameInstance::OnDestroySessionComplete(FName SessionName, bool bWasSuccessful)
{
...
void URTS_FPSGameInstance::DestroySessionAndLeaveGame()
{
	IOnlineSubsystem* OnlineSub = IOnlineSubsystem::Get();
	if (OnlineSub)
	{
